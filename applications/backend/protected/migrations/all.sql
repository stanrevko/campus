...
insert  into `admin_activity_log`(`id`,`date`,`ip`,`admin_name`,`action`,`entity`,`message`,`additional`) values (1,'2014-01-11 22:58:47','127.0.0.1','Admin (admin)','login',NULL,'Admin (admin) logged in',NULL),(2,'2014-01-14 23:32:48','127.0.0.1','Admin (admin)','login',NULL,'Admin (admin) logged in',NULL),(3,'2014-01-14 23:33:25','127.0.0.1','Admin (admin)','create','admin','Admin (admin) added new admin manager1 (#)','Attributes:  \"super_admin\" = \"0\", \"a_login\" = \"manager1\", \"name\" = \"manager1\", \"a_password\" = \"7647c210c9d978747cf2e2e12470fc275e5b1ddd\", \"id\" = \"2\",'),(4,'2014-01-14 23:33:32','127.0.0.1','Admin (admin)','logout',NULL,'Admin (admin) logged out',NULL),(5,'2014-01-14 23:33:58','127.0.0.1','Admin (admin)','login',NULL,'Admin (admin) logged in',NULL),(6,'2014-01-14 23:35:06','127.0.0.1','Admin (admin)','login',NULL,'Admin (admin) logged in',NULL),(7,'2014-01-14 23:35:22','127.0.0.1','Admin (admin)','update','admin','Admin (admin) updated admin manager1 (#)','Changed attributes \"a_password\" from \"7647c210c9d978747cf2e2e12470fc275e5b1ddd\" to \"e1cb4428c46408cd3ffb9ba810cc7c833f6c9621\",'),(8,'2014-01-14 23:35:28','127.0.0.1','Admin (admin)','logout',NULL,'Admin (admin) logged out',NULL),(9,'2014-01-14 23:35:34','127.0.0.1','manager1 (manager1)','login',NULL,'manager1 (manager1) logged in',NULL),(10,'2014-01-14 23:36:25','127.0.0.1','manager1 (manager1)','logout',NULL,'manager1 (manager1) logged out',NULL),(11,'2014-01-14 23:36:34','127.0.0.1','Admin (admin)','login',NULL,'Admin (admin) logged in',NULL),(12,'2014-01-16 17:48:47','127.0.0.1','Admin (admin)','login',NULL,'Admin (admin) logged in',NULL);
...
insert  into `kind`(`id`,`title`,`desc`) values (1,'лекція',NULL),(2,'вид2',NULL),(3,'вид3',NULL),(4,'вид4',NULL),(5,'вид5',NULL);
...
CREATE TABLE `material` (
  ...
  `term` int(2) DEFAULT NULL COMMENT 'семестр 1-12',
...
insert  into `material`(`id`,`title`,`desc`,`author_id`,`teacher_id`,`subj_id`,`type_id`,`kind_id`,`term`,`year`,`created`,`updated`,`state`) values (1,'Шпора',NULL,NULL,1,2,1,1,9,2009,NULL,NULL,1),(2,'Материал2','описание какоето',NULL,4,2,3,1,1,NULL,NULL,NULL,2),(3,'Материал2',NULL,NULL,3,4,1,5,1,NULL,NULL,NULL,0),(6,'Материал2',NULL,NULL,1,3,1,1,1,NULL,NULL,NULL,0),(7,'Материал2',NULL,NULL,2,1,1,2,1,NULL,NULL,NULL,0),(12,'Материал2',NULL,NULL,1,3,1,1,1,NULL,NULL,NULL,0),(13,'Материал2',NULL,NULL,1,1,5,1,1,NULL,NULL,NULL,0),(15,'Материал2',NULL,NULL,1,1,3,1,1,NULL,NULL,NULL,0),(19,'Материал2',NULL,NULL,5,5,5,5,5,NULL,NULL,NULL,0),(20,'Материал2',NULL,NULL,1,4,1,3,1,NULL,NULL,NULL,0),(21,'Материал2',NULL,NULL,3,4,1,4,4,NULL,NULL,NULL,0),(22,'Материал2',NULL,NULL,4,2,4,4,4,NULL,NULL,NULL,0),(23,'Матеріал тест Форм','',NULL,2,4,5,5,11,2013,'2014-01-16 19:16:45','2014-01-16 19:21:31',0),(24,'фівафіва23','фівафіва',NULL,2,5,4,2,4,2013,'2014-01-16 19:21:59','2014-01-16 19:22:28',0);
...
insert  into `subject`(`id`,`title`,`desc`) values (1,'Предмет1',NULL),(2,'Предмет2',NULL),(3,'Предмет3',NULL),(4,'Предмет4',NULL),(5,'Предмет5',NULL);
