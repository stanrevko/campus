...
class Material extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('author_id, teacher_id, subj_id, type_id, kind_id, status', 'numerical', 'integerOnly'=>true),
			...
			array('id, title, desc, author_id, teacher_id, subj_id, type_id, kind_id, term, year, created, updated, status', 'safe', 'on'=>'search'),
		);
	}
